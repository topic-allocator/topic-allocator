...
[updated_at] DATETIME2 NOT NULL CONSTRAINT [course_updated_at_df] DEFAULT CURRENT_TIMESTAMP;
...
[updated_at] DATETIME2 NOT NULL CONSTRAINT [instructor_updated_at_df] DEFAULT CURRENT_TIMESTAMP;

-- AlterTable
ALTER TABLE [dbo].[student] ADD [created_at] DATETIME2 NOT NULL CONSTRAINT [student_created_at_df] DEFAULT CURRENT_TIMESTAMP,
[updated_at] DATETIME2 NOT NULL CONSTRAINT [student_updated_at_df] DEFAULT CURRENT_TIMESTAMP;
...
[updated_at] DATETIME2 NOT NULL CONSTRAINT [student_course_completion_updated_at_df] DEFAULT CURRENT_TIMESTAMP;
...
[updated_at] DATETIME2 NOT NULL CONSTRAINT [student_topic_preference_updated_at_df] DEFAULT CURRENT_TIMESTAMP;

-- AlterTable
ALTER TABLE [dbo].[topic] ADD [created_at] DATETIME2 NOT NULL CONSTRAINT [topic_created_at_df] DEFAULT CURRENT_TIMESTAMP,
[updated_at] DATETIME2 NOT NULL CONSTRAINT [topic_updated_at_df] DEFAULT CURRENT_TIMESTAMP;
...
[updated_at] DATETIME2 NOT NULL CONSTRAINT [topic_course_preference_updated_at_df] DEFAULT CURRENT_TIMESTAMP;
